# Contributing to sodium-javascript-plus
...
Fork the project [on GitHub](https://github.com/geut/sodium-javascript-plus) and check out your copy locally.

```bash
$ git clone git@github.com:username/sodium-javascript-plus.git
$ cd sodium-javascript-plus
$ npm install
$ git remote add upstream git://github.com/geut/sodium-javascript-plus.git
```
