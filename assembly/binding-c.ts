...
export function crypto_aead_chacha20poly1305_ietf_encrypt(
  ...
  return sodiumC.crypto_aead_chacha20poly1305_ietf_encrypt(c, clen, m, u64(mlen), ad, u64(adlen), nsec, npub, k)
}
...
export function crypto_aead_chacha20poly1305_ietf_decrypt(
  ...
  return sodiumC.crypto_aead_chacha20poly1305_ietf_decrypt(m, mlen, nsec, c, u64(clen), ad, u64(adlen), npub, k)
}
