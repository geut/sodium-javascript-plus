...
module.exports = (sodiumJS, heap) => {
  ...
  const bindingJS = loader.instantiateSync(fs.readFileSync(`${__dirname}/../build/binding-js.wasm`), {
    'sodium-js': {
  ...
  return {
    env: {
      ...
      crypto_generichash: bindingJS.crypto_generichash.original,
      crypto_generichash_update: bindingJS.crypto_generichash_update.original
    },
